...
/*******************************
 *	LexAnalyzer class - performs lexical analysis of input file
...
public class LexAnalyzer {
    ...
    public LexAnalyzer() {
        ...
        outputVec = new Vector<>(10, 10);
        storedInput = new Vector<>(10, 10);
        index = 0;

    }

    /******************
     *	Analyzes input char by char and stores in outputVec and storedInput accordingly
    ...
    /*************************************************
     *	Stores the identifier in identifierArray.
     *  @author - Ryan Patterson
     *	@date - 6/4/10
     **************************************************/
